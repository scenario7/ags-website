            ...
            return (
              <div key={pkg.priceID}>
                ...
                <div className="flex flex-col">
                  ...
                  />
                  <div
                    className={`${futuraMedium.className} gap-2 bg-gradient-to-t from-[#2341FF] to-[#2341FF80] -mt-4 rounded-xl pt-8 pb-4 text-white text-sm flex flex-col items-center `}
                  >
                    {pkg.laps.map((type) => {
                      return (
                        <div
