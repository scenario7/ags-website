    ...
    <div className="flex flex-col px-10 py-5 gap-5">
      <div className="flex flex-col md:flex-row items-center md:items-start md:justify-between text-[#0B1237]">
        ...
        <div className="hidden md:flex flex-col items-center gap-2">
          ...
          <div
            className={`${futuraMedium.className} tracking-tighter flex gap-3`}
          >
            <svg
              data-slot="icon"
              fill="none"
            ...
            <a href="tel:+33685321161">+33 (6) 85 32 11 61</a>
          </div>
          <div
            className={`${futuraMedium.className} tracking-tighter flex gap-3`}
          >
        ...
        <div className="flex flex-col items-center gap-3 text-[#0B1237] text-center">
          ...
          <p
            className={`${futuraMedium.className} tracking-tighter text-center`}
          >
            ZA Circuit du Var
            <br />
            83590 GONFARON - FRANCE
          </p>
        </div>
        ...
        <div className="hidden md:flex flex-col text-right tracking-tighter gap-2">
          ...
          <div className="flex gap-2">
            <Link href="https://www.tiktok.com/@agsformule1?is_from_webapp=1&sender_device=pc">
              <FaTiktok className="h-8 w-8 text-[#0B1237]" />
            </Link>
            <Link href="https://www.instagram.com/agsformule1/">
              <FaInstagram className="h-8 w-8 text-[#0B1237]" />
            </Link>
            <Link href="https://www.facebook.com/agsformule1?locale=fr_FR">
              <FaFacebook className="h-8 w-8 text-[#0B1237]" />
            </Link>
            <Link href="https://www.linkedin.com/company/ags-formule-1-racing-events/">
      ...
      <div className="flex flex-col md:flex-row md:gap-3 items-center justify-end">
        <h3 className={`text-center text-sm md:text-md ${futuraLight.className}`}>
          Developed and maintained by DesiRacingCo
        </h3>
