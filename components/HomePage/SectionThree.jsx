  ...
  return (
    <div className="flex flex-col items-center py-20 gap-20">
        ...
        <div className="flex flex-col items-center">
          <div className="flex justify-center gap-4">
            ...
            <div className="relative w-10 h-10">
              <svg fill="#ffffff" strokeWidth="1.5" stroke="#ffffff" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="absolute inset-0">
                <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z" />
              </svg>
              <svg fill="#09144A" strokeWidth="1.5" stroke="#09144A" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="absolute inset-0" style={{ clipPath: "inset(0 50% 0 0)" }}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z" />
              </svg>
            </div>
          </div>
      ...
      <div className="overflow-hidden w-full py-10">
        <motion.div ref={carouselRef} className="flex gap-5 md:gap-10" animate={{ x: [0, -width, 0] }} transition={{ repeat: Infinity, duration: 20, ease: "linear" }}>
